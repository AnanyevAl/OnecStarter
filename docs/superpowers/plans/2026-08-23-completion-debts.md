...
- Produces: `format_size` с арифметическим округлением в обеих ветках —
...
Решение: округлять арифметически в обеих ветках; если округление целой ветки
...
6. `**Закрыт (23.08.2026):** округление арифметическое в обеих ветках с переносом единицы (1023,6 КБ → «1 МБ»); три новые строки таблицы. Табличный тест чистой функции — без мутационной проверки (правило проекта).`
