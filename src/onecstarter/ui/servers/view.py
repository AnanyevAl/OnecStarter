...
решение заказчика 4 от 29.08.2026) и `STOPPED`. Сама таблица состояний
и все чистые тексты карточки с 01.09.2026 живут в
`ui/servers/card_state.py` (долг T-12, п. 10) — здесь остались только
сборка виджетов и проводка. Кнопка «Погасить»
