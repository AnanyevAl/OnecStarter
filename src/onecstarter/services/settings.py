...
def _hotkey_of(value: Any) -> str:
    """Пустая строка — «выключен» (валидно). Непригодная — дефолт (спека §4.5).  # noqa: RUF003

    Годная строка возвращается канонизованной: иначе одно сочетание  # noqa: RUF002
    попадёт в файл двумя написаниями и сравнение «изменилось ли» соврёт.  # noqa: RUF003
    """
...
def _recent_of(value: Any) -> int:
    """Границы 0-50; не-целое — дефолт.  # noqa: RUF003
