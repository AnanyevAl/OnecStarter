...
def is_enabled(registry: Registry) -> bool:
    ...
    будет исправно. Единственное исключение — значение пустое или состоящее
    из одних пробельных символов: оно не запускает ничего.

    Формулировка расширена 22.08.2026 по находке мутационной проверки:
