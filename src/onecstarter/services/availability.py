...
# командной строки запуска», ключ `/F <каталог>` — «Каталог с файлом  # noqa: RUF003
# 1Cv8.1CD» (скил platform-launch, reference.md). Не измерены на реальной  # noqa: RUF003
...
# после него пометка меняется на [Ф] со ссылкой  # noqa: RUF003
