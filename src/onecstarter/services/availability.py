...
# правил одну строку.
#
# Достоверность — [Ф], замер T-05.17 (docs/research/t05-17-file-infobase-directory.md,
# 10.09.2026): smoke собранного 2.4.0 на рабочем списке заказчика — живые базы
# без крестика, значит stat(<каталог>/1Cv8.1CD) успешен для каждой; база
# с удалённым каталогом помечена. Источник имени — ИТС, «Приложение 7»,  # noqa: RUF003
# ключ /F (скил platform-launch, reference.md). Регистр имени на диске
# не снимался (для stat на Windows безразличен); поведение платформы
# на каталоге без файла не проверялось — на работу пробы не влияет.
